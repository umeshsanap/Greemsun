...
const ScrollCard: React.FC<{ 
  ...
  return (
    <div 
      className={`flex-shrink-0 w-80 h-80 p-8 rounded-full text-white shadow-xl transition-all duration-500 cursor-pointer relative flex flex-col items-center justify-center ${isHovered ? 'border-2 border-secondary z-50' : 'border-2 border-transparent z-10'}`}
      style={{
    ...
    >
      ...
      >
        <IconComponent className={`w-12 h-12 transition-colors duration-500 ${isHovered ? 'text-primary' : 'text-secondary'}`} />
      </div>
      <div className={`text-4xl font-black mb-1 transition-colors duration-500 ${isHovered ? 'text-primary' : 'text-secondary'}`}>{number}</div>
      <div className={`text-sm font-semibold text-center transition-colors duration-500 ${isHovered ? 'text-gray-800' : 'text-nature-100'}`}>{label}</div>
    </div>
  );
};
...
const Home: React.FC = () => {
  ...
  return (
    <div className="overflow-x-hidden overflow-y-visible">
        ...
        <div className="absolute inset-0 z-0 flex" style={{ width: `${slidesWithClone.length * 100}%`, transform: `translateX(-${currentSlide * (100 / slidesWithClone.length)}%)`, transition: isTransitioning ? 'transform 0.8s cubic-bezier(0.4, 0, 0.2, 1)' : 'none' }}>
          {slidesWithClone.map((slide, index) => (
            ...
            >
              ...
              <div className="relative z-10 text-left max-w-4xl px-8 md:px-12 lg:px-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 relative group">
              <div className="absolute -inset-4 bg-nature-100 rounded-3xl transform rotate-2 group-hover:rotate-1 transition-transform"></div>
              <img 
                src="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&q=80&w=1000" 
                className="relative rounded-3xl shadow-2xl object-cover h-[550px] w-full"
                alt="Import Export Trading"
              />
              <div className="absolute -bottom-6 -right-6 bg-primary text-white p-8 rounded-3xl shadow-2xl hidden md:block border-4 border-white">
                <span className="block text-4xl font-bold font-serif text-secondary">Quality</span>
                <span className="text-xs tracking-widest font-bold uppercase">First & Foremost</span>
              </div>
            </div>
            <div className="lg:w-1/2">
              <div className="w-20 h-1.5 bg-secondary mb-8"></div>
              <span className="text-primary font-black uppercase tracking-widest text-sm mb-4 block">Who We Are</span>
              <h2 className="text-4xl md:text-5xl font-serif text-secondary font-bold mb-8 leading-tight">Greemsun General Trading LLC</h2>
              ...
              <div className="grid grid-cols-2 gap-8 mb-12">
                <div className="flex items-center gap-4">
                  <div className="bg-nature-50 p-3 rounded-2xl"><CheckCircle className="text-primary" /></div>
                  <span className="font-bold text-primary-dark">Certified Sourcing</span>
                </div>
                <div className="flex items-center gap-4">
                  <div className="bg-nature-50 p-3 rounded-2xl"><CheckCircle className="text-primary" /></div>
                  <span className="font-bold text-primary-dark">Global Logistics</span>
                </div>
              </div>
              <Link 
                to="/about" 
                className="inline-flex items-center gap-3 px-8 py-4 bg-primary text-white rounded-xl font-bold hover:bg-primary-dark transition-all group"
              >
                DISCOVER MORE <ChevronRight size={18} className="group-hover:translate-x-1 transition-transform" />
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-nature-50 relative overflow-hidden group">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-12 rounded-[2.5rem] shadow-xl hover:shadow-2xl transition-all duration-500 border-l-8 border-primary group hover:-translate-y-2 hover:scale-[1.02] relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 rounded-full -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-700"></div>
              <div className="bg-primary-dark w-20 h-20 rounded-3xl flex items-center justify-center mb-10 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 relative z-10">
                <Shield className="text-secondary w-10 h-10 group-hover:scale-125 transition-transform duration-300" />
              </div>
              <h3 className="text-3xl font-serif font-bold text-primary mb-6 group-hover:text-secondary transition-colors duration-300 relative z-10">Our Mission</h3>
              <p className="text-gray-600 leading-relaxed text-lg relative z-10 group-hover:text-gray-700 transition-colors duration-300">
            ...
            <div className="bg-primary p-12 rounded-[2.5rem] shadow-xl hover:shadow-2xl transition-all duration-500 border-r-8 border-secondary group text-white hover:-translate-y-2 hover:scale-[1.02] relative overflow-hidden">
              <div className="absolute top-0 left-0 w-32 h-32 bg-secondary/10 rounded-full -ml-16 -mt-16 group-hover:scale-150 transition-transform duration-700"></div>
              <div className="bg-secondary w-20 h-20 rounded-3xl flex items-center justify-center mb-10 group-hover:scale-110 group-hover:-rotate-6 transition-all duration-500 relative z-10">
                <Globe className="text-primary-dark w-10 h-10 group-hover:scale-125 transition-transform duration-300" />
              </div>
              <h3 className="text-3xl font-serif font-bold mb-6 text-secondary group-hover:scale-105 transition-transform duration-300 relative z-10">Our Vision</h3>
              <p className="text-nature-100 leading-relaxed text-lg relative z-10 group-hover:text-white transition-colors duration-300">
      ...
      <section className="pt-8 pb-12 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-secondary font-black uppercase tracking-widest text-sm mb-2 block">Our Categories</span>
            <h2 className="text-4xl md:text-5xl font-serif text-primary font-bold">What We Provide</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="group relative rounded-[2rem] overflow-hidden shadow-2xl h-[500px]">
                ...
                <div className="absolute bottom-0 left-0 p-10 transform translate-y-6 group-hover:translate-y-0 transition-transform duration-700">
                  <div className="w-12 h-1 bg-secondary mb-4"></div>
                  <h4 className="text-3xl font-bold text-white mb-2">{item.title}</h4>
                  <p className="text-gray-300 opacity-0 group-hover:opacity-100 transition-opacity duration-700 delay-200">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section ref={horizontalScrollRef} className="pt-8 pb-8 bg-white overflow-visible">
        <div className="w-full overflow-x-hidden overflow-y-visible">
          <div className="horizontal-scroll-content flex gap-8 will-change-transform py-8">
            {[
      ...
      <section 
        ref={whyChooseUsRef}
        className="py-24 bg-white text-primary transition-transform duration-500 hover:scale-[1.05] relative overflow-hidden"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between mb-20 gap-10">
            <div className="md:w-1/2">
              <span className="text-secondary font-bold uppercase tracking-widest text-sm mb-4 block">The Greemsun Standard</span>
              <h2 className="text-4xl md:text-5xl font-serif font-bold leading-tight">Why We are Your Trusted Export Partner</h2>
            </div>
            <div className="md:w-1/2 border-l-4 border-secondary pl-10">
                ...
                <div className="w-full h-80 overflow-hidden relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <div className="text-center px-6">
                      <p className="text-base font-medium leading-relaxed text-black" style={{ fontFamily: 'Times New Roman, serif' }}>{card.desc}</p>
                    </div>
                  </div>
                </div>
                {/* Title Below Image */}
                <div className="p-6 bg-white">
                  <h4 className="text-xl font-black text-primary text-center" style={{ fontFamily: 'Times New Roman, serif' }}>{card.title}</h4>
                </div>
              </div>
            ))}
          </div>
      ...
      <section ref={processSectionRef} className="py-8 bg-white relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-8">
            <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-2">How It Works</h2>
            <p className="text-xl text-gray-600">Process</p>
          </div>
        </div>
        ...
        <div 
          ...
          style={{
            maxHeight: '450px', // Show exactly 2 cards (each card ~160px min-height + spacing)
                ...
                <div className="bg-white rounded-xl shadow-xl p-6 md:p-8 relative z-10 ml-16 md:ml-20 flex items-center min-h-[160px] group transition-shadow duration-300 hover:shadow-[8px_8px_20px_0_rgba(234,179,8,0.4)]">
                  <div className="absolute -left-12 md:-left-16 top-1/2 -translate-y-1/2 z-20">
                    <div className="bg-secondary w-20 h-28 md:w-24 md:h-32 flex flex-col items-center justify-center rounded-lg shadow-lg">
                      ...
                      <span className="text-white text-3xl md:text-4xl font-bold">01</span>
                    </div>
                  </div>
                  ...
                  <div className="ml-8 md:ml-12">
                    <h3 className="text-xl md:text-2xl font-bold text-secondary mb-3 md:mb-4 text-left">Inquiry & Consultation</h3>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-4xl font-bold text-primary-dark mb-4">Certifications & Compliance</h2>
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-12 items-start">
            {[
              ...
              <div 
                key={idx} 
                className="flex flex-col items-center group cursor-pointer max-w-[240px]"
              >
                <div className="w-56 h-56 bg-white rounded-full shadow-xl flex items-center justify-center mb-4 transition-all duration-500 group-hover:shadow-2xl overflow-hidden relative border-2 border-gray-200">
                  <img 
                    src={cert.image} 
                    alt={cert.name}
                  ...
                  >
                    <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-500 text-center text-white font-bold text-sm sm:text-base md:text-lg leading-tight px-6 py-2 z-10 w-full max-w-[85%] break-words">
                      {cert.name}
                    </div>
                  </div>
                </div>
                <p className="text-sm text-gray-700 leading-relaxed text-center mt-2">{cert.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative min-h-[600px] flex items-center justify-center text-white overflow-hidden py-16">
        <div 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-4xl">
              <span className="text-secondary font-black uppercase tracking-widest text-sm mb-6 block">Premium Selection</span>
            <h2 className="text-4xl md:text-5xl lg:text-7xl font-serif font-bold mb-10 leading-tight">Harvested with <br /><span className="text-secondary">Purity & Care</span></h2>
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-16">
                {[
                  '100% Pesticide Free',
                  'Freshness Guaranteed',
                  'UV Treated Processing',
                  'Sustainable Packaging',
                  'Direct Farm Sourcing',
                  'Standardized Grading'
                ].map((feature, i) => (
                  <li key={i} className="flex items-center gap-4 text-gray-100">
                    <div className="bg-secondary p-1 rounded-full"><CheckCircle size={20} className="text-primary-dark" /></div>
              ...
              <Link 
                to="/products" 
              className="inline-block px-12 py-5 bg-secondary hover:bg-secondary-dark text-primary-dark rounded-full font-black transition-all shadow-2xl hover:shadow-secondary/40 text-lg uppercase tracking-wider transform hover:scale-105"
              >
